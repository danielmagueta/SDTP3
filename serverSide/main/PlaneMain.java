...
/**
 *    Instantiation and registering of a planeobject.
 *
   ...
   */
   ...
   public static void main (String[] args)
   {
     ...
     /* instantiate a plane object */
      ...
      DepartureAirportInterface planeStub = null;                          // remote reference to the plane object

      try
      { planeStub = (DepartureAirportInterface) UnicastRemoteObject.exportObject (plane, portNumb);
      }
      catch (RemoteException e)
     ...
     /* server shutdown */
      ...
      boolean shutdownDone = false;                                  // flag signalling the shutdown of the planeservice
